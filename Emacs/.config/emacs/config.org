...
I'm having to launch terminals quite often now for coding tasks, but I
code in Emacs - so I have to do a lot of context switching between the
coding harness TUI and my comfortable and kino editor.
...
buffer for all ~compile~ tasks; I'd like the ability to

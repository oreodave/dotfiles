...
(custom-set-variables
 ...
 '(csharp-mode-hook
   (quote
    (+rotate-text-init-csharp-mode-h +electric|init-csharp-mode rainbow-delimiters-mode +lookup--init-csharp-mode-handlers-h
                                     (closure
                                      (t)
                                      (&rest _)
                                      (add-hook
                                       (quote kill-buffer-hook)
                                       (function +csharp-cleanup-omnisharp-server-h)
                                       nil t))
                                     (lambda nil
                                       (setq c-basic-offset 4)
                                       (c-set-style "java")
                                       +rotate-text-init-csharp-mode-h +electric|init-csharp-mode rainbow-delimiters-mode omnisharp-mode +evil-embrace-angle-bracket-modes-hook-h)
                                     omnisharp-mode)) t)
 '(custom-safe-themes
   (quote
